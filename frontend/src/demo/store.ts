  ...
  return [
    {
      ...
      definition: definition([
        ...
        { id: 'event-plan', type: 'activity', position: { x: 330, y: 210 }, data: { label: 'Planung im Team', description: 'Zielgruppe, Termin, Raum und Ressourcen gemeinsam klären.', responsibleRole: 'Teamleitung', estimatedDurationMinutes: 90, resources: ['Raumbuchung', 'Budgetübersicht', 'Ablaufplan'], checklist: [{ id: 'event-plan-check-1', label: 'Zielgruppe einbeziehen' }, { id: 'event-plan-check-2', label: 'Schutzkonzept prüfen' }], startCondition: 'Anliegen und grober Termin sind mit dem Team geklärt.', completionCriterion: 'Termin, Raum, Verantwortung und Budget sind verbindlich festgehalten.' } },
        { id: 'event-decision', type: 'decision', position: { x: 620, y: 210 }, data: { label: 'Ist die Planung tragfähig?', description: 'Sind Ressourcen, Schutz und Beteiligung ausreichend berücksichtigt?', estimatedDurationMinutes: 20, paths: [{ id: 'yes', label: 'Ja', tone: 'positive' }, { id: 'no', label: 'Nein – anpassen', tone: 'negative' }] } },
        { id: 'event-branch', type: 'branch', position: { x: 910, y: 185 }, data: { label: 'Begleitende Arbeit', paths: [{ id: 'path-a', label: 'Bewerbung', tone: 'neutral' }, { id: 'path-b', label: 'Durchführung', tone: 'neutral' }] } },
        ...
        { id: 'event-run', type: 'activity', position: { x: 1210, y: 300 }, data: { label: 'Veranstaltung durchführen', responsibleRole: 'Veranstaltungsteam', estimatedDurationMinutes: 180 } },
        { id: 'event-rework', type: 'activity', position: { x: 910, y: 470 }, data: { label: 'Planung überarbeiten', responsibleRole: 'Planungsteam', description: 'Offene Voraussetzungen klären und die Entscheidung erneut prüfen.' } },
        ...
        { id: 'event-edge-3', source: 'event-decision', sourceHandle: 'path-yes', target: 'event-branch', label: 'Ja' },
        { id: 'event-edge-4', source: 'event-decision', sourceHandle: 'path-no', target: 'event-rework', label: 'Nein – anpassen' },
        { id: 'event-edge-5', source: 'event-branch', sourceHandle: 'path-path-a', target: 'event-marketing', label: 'Bewerbung' },
        { id: 'event-edge-6', source: 'event-branch', sourceHandle: 'path-path-b', target: 'event-run', label: 'Durchführung' },
        { id: 'event-edge-7', source: 'event-run', target: 'event-output' },
        { id: 'event-edge-8', source: 'event-output', target: 'event-reflection' },
      ]),
    },
    {
